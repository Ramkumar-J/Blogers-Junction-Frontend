...
function ReadBlog(){
    ...
    useEffect(() => {
        async function getBlog(){
            try {
                let singleblog=await axios.get(`http://localhost:3001/blogs/${params.id}`);
    ...
    return(
        <div className="container">
            ...
            <img className="img-size mt-3" src={readblog.blogimage}></img>
            <p className="fs-5 mt-3 mb-2"><strong className="text-primary">Created By</strong> - {readblog.creatorname}</p>
            <p className="fs-5"><strong className="text-primary">Published on</strong> - {readblog.published}</p>
